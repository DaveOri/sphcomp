# -*- coding: utf-8 -*-
"""
Created on Tue May 29 16:25:16 2018
...
freq_str='X'
data_folder = '/home/dori/dda_parameters/pol_int/'
for polint in polints:#.keys():#[0:1]:
    f = freqs[freq_str]
    lam = fr2lam(f)
    k2 = 4.*(np.pi/lam)**2
    print(f,lam)
...
#            pass
    ...
    DDAdict[polint] = DDA#[0:-1]
    MIEdict[polint] = MIE#[0:-1]
#%%
