# -*- coding: utf-8 -*-
"""
Created on Tue Feb 27 16:23:19 2018
...
ax11.text(0.7,0.7,'X-band',transform=ax11.transAxes,fontdict=dict(fontweight='bold'), bbox=dict(facecolor='white', alpha=0.5))
ax21.text(0.7,0.7,'Ku-band',transform=ax21.transAxes,fontdict=dict(fontweight='bold'), bbox=dict(facecolor='white', alpha=0.5))
...
ax42.set_ylabel('P$_{11}$ relative error  [%]')
ax52.set_ylabel('P$_{11}$ relative error  [%]')
